...
z6 <- cvars$fivevote    # Country: UN- UN Vote distance with U.S.
      ...
      ## Alternative DV, using just the 4-item Anti-Americanism question 
# (appendix) y <- (mus$us-1)/3   #  Anti-Americanism: 1=most AA, 0=least AA
...
round(bugs.model$mean$mu.musid+bugs.model$mean$mu.news,2)
      ...
      # Model 4, with z1 as percent religious instead of percent seeing a 
      # struggle
z1 <- cvars$pctrel              # Country: percent or total religious
...
round(bugs.model$mean$mu.pious+bugs.model$mean$mu.news,2)
      ...
      # Model 6, with z1 as percent religious instead of percent seeing a 
      # struggle
z1 <- cvars$pctrel              # Country: percent or total religious
